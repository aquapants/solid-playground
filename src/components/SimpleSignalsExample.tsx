...
const SimpleSignalsExample = () => {
  ...
  return (
    <div class="flex w-[32rem] flex-col border-2 p-2">
      ...
      <p>
        If you're coming from a React background you can think of `createSignal`
        as `useState` in React
      </p>
      <div class="text bg-slate-400flex my-auto flex-col text-2xl font-bold">
        <p>
